/**
 * @module sb-log.log.horizontal.class
 */
...
/**
 * A class used to log multiple strings side by side. Each of the strings has
 * its own logger.
 */
class SbLogHorizontal extends SbLogCore {

  /**
   * The loggers, used to log each string.
   * @type {Array<SbLogCore>}
   */
  logs;

  /**
   * The width of the separator string.
   * @type {number}
   */
  get separatorWidth() {
  ...
  /**
   * Instantiates a new `SbLogHorizontal` object with the appropriate options.
