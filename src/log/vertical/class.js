/**
 * @module sb-log.log.vertical.class
 */
...
/**
 * A class used to log multiple strings ontop of each other. Each of the strings
 * has its own logger.
 */
class SbLogVertical extends SbLogCore {
  ...
  /**
   * Instantiates a new `SbLogVertical` object with the appropriate options.
