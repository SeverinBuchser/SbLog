...
/**
 * @classdesc A core class to define options with unified options handling and
 * merging.
 */
class SbOptions {
  /**
   ...
   * @return {object} The default options to use.
   */
   ...
   * @param {object} defaults The default options.
   * @return {object} The options to use.
   */
