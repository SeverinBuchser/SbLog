 ...
 */
  ...
  * @param {SbLines | Array<string>} lines The input lines.
  * @returns {SbLines | Array<string>} The original lines.
  */
 const none = lines => lines;
  ...
  * as well as replaces all corners inside the block with the appropriate
